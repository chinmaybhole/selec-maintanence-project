...
routers.get(
  "/user",
  checkAuth,
  checkRole(config.ROLE.TECHNICIAN_INTERNAL),
  technicianControllers.getCurrentUser
);
...
routers.post(
  ...
  upload.single("image"),
  uploadImage,
  technicianControllers.imageUpload
);
...
routers.get(
  ...
  checkAuth,
  checkRole(config.ROLE.TECHNICIAN_INTERNAL),
  technicianControllers.workOrder
);
...
routers.get(
  ...
  checkAuth,
  checkRole(config.ROLE.TECHNICIAN_INTERNAL),
  technicianControllers.ticketDisplay
);
...
routers.patch(
  ...
  checkAuth,
  checkRole(config.ROLE.TECHNICIAN_INTERNAL),
  technicianControllers.ticketAccept
);
